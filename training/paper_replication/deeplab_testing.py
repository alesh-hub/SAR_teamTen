...
wandb_logger = WandbLogger(
    project='SAR_ADSP_2425',  # Replace with your project name
    name='trial_deeplab'          # Replace with your experiment name
)
...
class SARSegmentationModel(LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        save_prediction_images(masks, preds, result_folder='result_test')
